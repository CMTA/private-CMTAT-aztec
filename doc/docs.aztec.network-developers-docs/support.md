...
> Source: https://docs.aztec.network/developers/support
...
## Ask first: Forum and Discord[​](#ask-first-forum-and-discord)
...
### What a high-quality bug report includes[​](#what-a-high-quality-bug-report-includes)
...
### Where bugs in specific components go[​](#where-bugs-in-specific-components-go)
...
## Operator and node issues[​](#operator-and-node-issues)
...
Operator-specific guides live in the [Operate section](https://docs.aztec.network/operate/operators).
...
[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/support.md)