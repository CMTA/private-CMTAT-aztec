...
> Source: https://docs.aztec.network/developers/docs/foundational-topics/advanced/circuits/avm_compatibility
...
## What Error Will I See?[​](#what-error-will-i-see)
...
## Signature Verification in Public: Workarounds[​](#signature-verification-in-public-workarounds)
...
This is exactly how public authwits work. See [Authentication Witnesses](https://docs.aztec.network/developers/docs/foundational-topics/advanced/authwit) for the full pattern.

Schnorr signaturesThe [`noir-lang/schnorr`](https://github.com/noir-lang/schnorr) library implements Schnorr verification in pure Noir using embedded curve operations (ECADD, MSM), which are supported in the AVM. This means Schnorr verification may work in public functions. However, the standard Aztec account contracts only use Schnorr in private functions, and the recommended pattern remains verifying signatures in private via the Auth Registry.
...
- [Public Execution (AVM)](https://docs.aztec.network/developers/docs/foundational-topics/advanced/circuits/public_execution) – How the AVM executes public functions
- [Authentication Witnesses](https://docs.aztec.network/developers/docs/foundational-topics/advanced/authwit) – The Auth Registry pattern for public authorization
...
[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/docs/foundational-topics/advanced/circuits/avm_compatibility.md)