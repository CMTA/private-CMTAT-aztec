...
> Source: https://docs.aztec.network/developers/docs/foundational-topics/pxe/kernelless_simulations
...
## What the PXE still does[​](#what-the-pxe-still-does)
...
## Simulation overrides[​](#simulation-overrides)
...
```
type ContractOverrides = Record<  string,  { instance: ContractInstanceWithAddress }>;class SimulationOverrides {  publicStorage?: PublicStorageOverride[];  contracts?: ContractOverrides;}
```
...
For the cheat that simulates a contract as if it had already been upgraded to a new class, see [`fastForwardContractUpdate`](https://docs.aztec.network/developers/docs/aztec-js/how_to_test#fast-forwarding-a-contract-update), which returns a `SimulationOverrides` covering both the registry storage rewrite and the upgraded instance entry.

## Stub account contracts[​](#stub-account-contracts)
...
## Authwit requests come from the app, not the stub[​](#authwit-requests-come-from-the-app-not-the-stub)
...
## Where kernelless does not apply[​](#where-kernelless-does-not-apply)
...
## Gas estimation parity[​](#gas-estimation-parity)
...
## Multi-account scopes[​](#multi-account-scopes)
...
## When you might still want a full simulation[​](#when-you-might-still-want-a-full-simulation)
...
- [Simulate without signing prompts](https://docs.aztec.network/developers/docs/aztec-js/how_to_simulate_without_signing) for the recipe-oriented version of this page.
- [Reading contract data](https://docs.aztec.network/developers/docs/aztec-js/how_to_read_data) for the basic `.simulate()` API.
- [Wallets](https://docs.aztec.network/developers/docs/foundational-topics/wallets) for the wallet's role in capturing private authorizations during simulation.

**Tags:**
- [pxe](https://docs.aztec.network/developers/tags/pxe)
- [simulation](https://docs.aztec.network/developers/tags/simulation)
- [gas estimation](https://docs.aztec.network/developers/tags/gas-estimation)

[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/docs/foundational-topics/pxe/kernelless_simulations.md)