...
> Source: https://docs.aztec.network/developers/docs/foundational-topics
...
Prefer video? This explainer covers the core idea in under 90 seconds, and there are more [video lessons](https://docs.aztec.network/developers/docs/resources/video_lessons) available.
...
[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/docs/foundational-topics/index.md)