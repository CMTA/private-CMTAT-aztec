...
> Source: https://docs.aztec.network/developers/docs/tutorials/js_tutorials/wallet-extension/testing
...
```
# Install dependencies if neededyarn install# Build the extensionnode esbuild.extension.mjs
```
...
## Deploying an Account[​](#deploying-an-account)
...
```
[offscreen] Initializing wallet...[offscreen] Wallet initialized[offscreen] Received message: deploy-account
```
...
```
cd docs/examples/webapp-tutorial# Start the dev serveryarn dev
```
...
## Verifying on Explorer[​](#verifying-on-explorer)
...
[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/docs/tutorials/js_tutorials/wallet-extension/07-testing.md)