...
## What can Aztec keep private?[​](#what-can-aztec-keep-private)
...
dangerPrivacy is not guaranteed without care.
...
## Leaky practices[​](#leaky-practices)
...
### Crossing the private to public boundary[​](#crossing-the-private-to-public-boundary)
...
### Crossing the public to private boundary[​](#crossing-the-public-to-private-boundary)
...
### Timing of transactions[​](#timing-of-transactions)
...
In short, you should think about the *timing* of user transactions and how this might leak information.

### Function Fingerprints and Tx Fingerprints[​](#function-fingerprints-and-tx-fingerprints)
...
- The *number* of some ['side effects'](https://en.wikipedia.org/wiki/Side_effect_(computer_science)). Note hashes, nullifiers, and private logs are padded to hide their true counts, but the following remain visible:
...
#### Standardizing Fingerprints[​](#standardizing-fingerprints)
...
#### What kind of queries can be leaky?[​](#what-kind-of-queries-can-be-leaky)

##### Querying for up-to-date note sibling paths[​](#querying-for-up-to-date-note-sibling-paths)
...
[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/docs/resources/considerations/privacy_considerations.md)