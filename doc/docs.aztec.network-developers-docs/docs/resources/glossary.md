...
### ACIR (Abstract Circuit Intermediate Representation)[​](#acir-abstract-circuit-intermediate-representation)
...
### AVM (Aztec Virtual Machine)[​](#avm-aztec-virtual-machine)
...
Full reference [here](https://docs.aztec.network/developers/docs/cli/aztec_cli_reference).
...
Full reference [here](https://docs.aztec.network/developers/docs/cli/aztec_wallet_cli_reference).
...
### Noir Language Server[​](#noir-language-server)
...
To run your own node see [here](https://docs.aztec.network/operate/operators).
...
### Programmable Privacy[​](#programmable-privacy)
...
Read more [here](https://docs.aztec.network/developers/docs/foundational-topics/pxe).
...
### Zero-knowledge (ZK) proof[​](#zero-knowledge-zk-proof)
...
- [glossary](https://docs.aztec.network/developers/tags/glossary)

[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/docs/resources/glossary.md)