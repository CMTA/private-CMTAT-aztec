...
> Source: https://docs.aztec.network/developers/docs/cli/aztec_wallet_cli_reference
...
- `-n --node-url <string>` - URL of the Aztec node to connect to (default: "[http://host.docker.internal:8080](http://host.docker.internal:8080)", env: AZTEC_NODE_URL)
...
[Edit this page](https://github.com/AztecProtocol/aztec-packages/edit/next/docs/docs-developers/docs/cli/aztec_wallet_cli_reference.md)