...
- In this repository: `doc/README.md` (design and privacy analysis of the token), `doc/standards/cmtat-vs-aip20.md`, `doc/design/token-module.md`, `doc/audits/tools/` (code-quality reviews with measured gate counts).
