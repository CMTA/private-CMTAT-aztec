...
This code is copyright (c) 2025 Taurus SA and is dual-licensed under the [MIT](LICENSE-MIT.md) and [MPL-2.0](LICENSE-MPL.md) licenses. You may choose either license. We are not aware of any patent or patent application covering the techniques implemented.
