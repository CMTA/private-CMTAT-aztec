...
- Added `doc/standards/aip20-features-for-cmtat.md`, assessing which AIP-20 features the token could adopt while staying CMTAT-equivalent, each tested against the equivalency criteria, the token's privacy premise, and measured cost.
